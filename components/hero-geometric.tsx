...
export default function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex -mt-20 items-center justify-center overflow-hidden bg-white dark:bg-[#030303] transition-colors duration-300">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            ...
            Our app revolutionizes the way we interact with AI chatbots. With our advanced technology, our chatbots think and reply like real characters, complete with authentic voices. 
            </p>
          </motion.div>
        </div>
      </div>
